...
// 8192 だと 0.6B でも KV キャッシュが 900MB 近くなり、8GB 端末では
// メモリ圧の原因になる。2048 なら 230MB 程度、通常会話に十分。
...
Java_com_localllm_app_llama_LLMEngine_init(JNIEnv *env, jobject /*unused*/, jstring nativeLibDir) {
...
Java_com_localllm_app_llama_LLMEngine_load(JNIEnv *env, jobject, jstring jmodel_path) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_localllm_app_llama_LLMEngine_prepare(JNIEnv * /*env*/, jobject /*unused*/) {
...
Java_com_localllm_app_llama_LLMEngine_systemInfo(JNIEnv *env, jobject /*unused*/) {
    return env->NewStringUTF(llama_print_system_info());
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_localllm_app_llama_LLMEngine_benchModel(JNIEnv *env, jobject /*unused*/, jint pp, jint tg,
                                                      jint pl, jint nr) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_localllm_app_llama_LLMEngine_processSystemPrompt(
        JNIEnv *env,
        jobject /*unused*/,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_localllm_app_llama_LLMEngine_processUserPrompt(
        JNIEnv *env,
        jobject /*unused*/,
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_localllm_app_llama_LLMEngine_generateNextToken(
        JNIEnv *env,
        jobject /*unused*/
) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_localllm_app_llama_LLMEngine_unload(JNIEnv * /*unused*/, jobject /*unused*/) {
    // Reset long-term & short-term states
    reset_long_term_states();
    reset_short_term_states();
...
extern "C"
JNIEXPORT void JNICALL
Java_com_localllm_app_llama_LLMEngine_shutdown(JNIEnv *, jobject /*unused*/) {
    llama_backend_free();
}
